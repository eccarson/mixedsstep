...
% using both loose and tighter bounds.
% The code will plot both the measured quantity and the bounds. 
%
...
% Call compplots_tight to run the algorithms and generate the plots 
compplots_tight(A, v, s, basis_info, options)