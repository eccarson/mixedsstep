...
% and deviation of AV and T, as well as the bounds on these quantities.
%
% Input:
...
function [results, basis_info] = ca_lanczos_bounds_vpa(A, v, s, basis_info, options)
